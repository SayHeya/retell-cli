...
# Push 2000 agent2-* agents to staging with 1s rate limiting
...
echo "========================================="
echo "Pushing 2000 $PREFIX-* agents to $WORKSPACE"
echo "Rate limit: ${DELAY}s delay"
echo "Expected time: ~33 minutes"
echo "========================================="
echo ""
...
for i in $(seq 1 $TOTAL); do
  ...
  AGENT_NUM=$(printf "%04d" $i)
  AGENT_NAME="${PREFIX}-${AGENT_NUM}"
