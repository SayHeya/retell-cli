...
describe('WorkspaceConfigLoader', () => {
  ...
  describe('load', () => {
    ...
    it('should return error if staging API key is missing', () => {
      process.env['RETELL_PRODUCTION_API_KEY'] = 'prod_key_456';
    ...
    it('should return error if production API key is missing', () => {
      process.env['RETELL_STAGING_API_KEY'] = 'staging_key_123';
  ...
  describe('getWorkspace', () => {
    ...
    it('should get staging workspace config', () => {
      const result = WorkspaceConfigLoader.getWorkspace('staging');
    ...
    it('should get production workspace config', () => {
      const result = WorkspaceConfigLoader.getWorkspace('production');
    ...
    it('should return error when env vars are missing', () => {
      delete process.env['RETELL_STAGING_API_KEY'];
      delete process.env['RETELL_PRODUCTION_API_KEY'];
